            ...
            <div class="row">
                <div class="col-lg-8">
                    <article class="pe-lg-5">
                        <div class="banner">
                            <p class="line"><strong class="cat">Education</strong><strong class="post-date bf">Wednesday, October 11, 2022 </strong></p>
                ...
                <div class="col-lg-4 side">
                    <div class="side-bar">
                        ...
                        ?>
                            <li>
                                <p class="line"><strong class="cat">Education</strong><strong class="post-date bf">October 11 </strong></p>
